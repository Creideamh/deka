                                    ...
                                    <tbody>
                                        @forelse ($members as $member)
                                            <tr  id="row_{{$member->id}}">
                                                ...
                                                <td>
                                                    <input type="text" name="gender_of_member[]" id="gender_1" value="{{ $member->gender }}" class="form-control" readonly >
                                                </td>
                                                <td>
                                                    <input type="text" name="birthdate_of_member[]" id="birthdate_of_member_1" value="{{ $member->birthdate }}" class="form-control" readonly>
                                                </td>
                                                <td>
                                                    <select name="relationship_of_member[]" id="relationship_of_member_1"  onchange="getBenefits(1)" class="form-control">
                                                        <option value="{{ $member->relationship_of_member }}" selected>{{ $member->relationship }}</option>
                                                        <option value="Main Life">Main Life</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" name="standard_premium[]" id="standard_premium_1" value="{{ $member->standard_premium }}" class="form-control" readonly>
                                                </td>
                                                <td>
                    ...
                    <div class="card-body">
                        ...
                        @if ($medical_info[0]->life_insurance_status == 'Yes')
                            <div class="col-md-4 float-end refusal_edit" >
                                ...
                                <input type="text" name="refusal" id="refusal" value="{{ $medical_info[0]->refusal_reasons }}"  class="form-control">
                            </div>
                        @else
                        ...
                        <div class="col-12 float-end proposed_edit">
